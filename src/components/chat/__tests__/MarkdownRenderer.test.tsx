...
test("renders h1 with chat-appropriate styling", () => {
...
test("renders h2 with chat-appropriate styling", () => {
  render(<MarkdownRenderer content="## Heading Two" />);
  const h2 = screen.getByRole("heading", { level: 2 });
  expect(h2.className).toContain("font-semibold");
  expect(h2.className).toContain("text-neutral-900");
});

test("renders h3 with chat-appropriate styling", () => {
  render(<MarkdownRenderer content="### Heading Three" />);
  const h3 = screen.getByRole("heading", { level: 3 });
  expect(h3.className).toContain("font-medium");
});

test("renders ul with list-disc and left margin", () => {
...
test("renders ol with list-decimal and left margin", () => {
...
test("renders li with text-sm styling", () => {
